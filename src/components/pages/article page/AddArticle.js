...
//     articleName: Yup.string().required('Article name is required'),
//     articleDesc: Yup.string().required('Description is required'),
//     articleFile: Yup.mixed().required('File is required').test(
//       'fileFormat',
...
//     e.preventDefault();
//     try {
//       await validationSchema.validate({ articleName: articleName, articleDesc: articleDesc, articleFile: articleUpload }, { abortEarly: false });
